...
exports.replaceCharacterPlaceholders = replaceCharacterPlaceholders;
exports.formatCharacterFields = formatCharacterFields;
exports.normaliseMetadata = normaliseMetadata;
exports.formatCharacterList = formatCharacterList;
...
function formatCharacterFields(data, fields, username, name) {
    return Object.fromEntries(fields.map(key => [key, replaceCharacterPlaceholders(data[key] || '', username, name)]));
}
